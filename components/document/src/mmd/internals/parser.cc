...
#define ParseTOKENTYPE  _sp_mmd_token *
typedef union {
  int yyinit;
  ParseTOKENTYPE yy0;
} YYMINORTYPE;
...
#endif
#define ParseARG_SDECL  _sp_mmd_engine * engine ;
#define ParseARG_PDECL , _sp_mmd_engine * engine
#define ParseARG_FETCH  _sp_mmd_engine __attribute__ ((unused)) * engine  = yypParser->engine
...
void ParseFree(
  ...
  void (*freeProc)(void*, size_t)     /* Function used to reclaim memory */
){
...
#endif
  (*freeProc)((void*)pParser, sizeof(yyParser));
}
...
{
		sp_mmd_strip_line_tokens_from_block(engine, yymsp[0].minor.yy0);
		if (yymsp[-1].minor.yy0 == NULL) { yymsp[-1].minor.yy0 = yymsp[0].minor.yy0; yymsp[0].minor.yy0 = NULL;}
		yylhsminor.yy0 = yymsp[-1].minor.yy0;
		sp_mmd_token_chain_append(yylhsminor.yy0, yymsp[0].minor.yy0);
		#ifndef NDEBUG
...
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_H1); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 4: /* block ::= LINE_ATX_2 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_H2); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 5: /* block ::= LINE_ATX_3 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_H3); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 6: /* block ::= LINE_ATX_4 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_H4); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 7: /* block ::= LINE_ATX_5 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_H5); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 8: /* block ::= LINE_ATX_6 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_H6); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 9: /* block ::= LINE_HR */
      case 10: /* block ::= LINE_YAML */ yytestcase(yyruleno==10);
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_HR); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 11: /* block ::= LINE_TOC */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_TOC); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 12: /* block ::= blockquote */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_BLOCKQUOTE); sp_mmd_recursive_parse_blockquote(engine, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 13: /* block ::= def_abbreviation */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_DEF_ABBREVIATION); sp_mmd_stack_push(engine->definition_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 14: /* block ::= def_citation */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_DEF_CITATION); sp_mmd_stack_push(engine->definition_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 15: /* block ::= def_footnote */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_DEF_FOOTNOTE); sp_mmd_stack_push(engine->definition_stack, yylhsminor.yy0); sp_mmd_recursive_parse_indent(engine, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 16: /* block ::= def_glossary */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_DEF_GLOSSARY); sp_mmd_stack_push(engine->definition_stack, yylhsminor.yy0); sp_mmd_recursive_parse_indent(engine, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 17: /* block ::= def_link */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_DEF_LINK); sp_mmd_stack_push(engine->definition_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 18: /* block ::= definition_block */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_DEFLIST); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 19: /* block ::= empty */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_EMPTY); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 20: /* block ::= fenced_block */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_CODE_FENCED); yymsp[0].minor.yy0->child->type = CODE_FENCE; }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 21: /* block ::= html_block */
      case 22: /* block ::= html_com_block */ yytestcase(yyruleno==22);
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_HTML); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 23: /* block ::= indented_code */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_CODE_INDENTED); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 24: /* block ::= list_bullet */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_LIST_BULLETED); sp_mmd_is_list_loose(yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 25: /* block ::= list_enum */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_LIST_ENUMERATED); sp_mmd_is_list_loose(yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 26: /* block ::= meta_block */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_META); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 27: /* block ::= meta_block LINE_SETEXT_2 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[-1].minor.yy0, BLOCK_META); sp_mmd_token_append_child(yylhsminor.yy0, yymsp[0].minor.yy0); }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 28: /* block ::= para */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_PARA); sp_mmd_is_para_html(engine, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 29: /* block ::= setext_1 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_SETEXT_1); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 30: /* block ::= setext_2 */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_SETEXT_2); sp_mmd_stack_push(engine->header_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 31: /* block ::= table */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_TABLE); sp_mmd_stack_push(engine->table_stack, yylhsminor.yy0); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
...
{ yylhsminor.yy0 = yymsp[-1].minor.yy0; sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 34: /* nested_chunk ::= empty indented_line chunk */
{ yylhsminor.yy0 = yymsp[-2].minor.yy0; sp_mmd_token_chain_append(yymsp[-2].minor.yy0, yymsp[-1].minor.yy0); sp_mmd_token_chain_append(yymsp[-2].minor.yy0, yymsp[0].minor.yy0); yymsp[-1].minor.yy0->type = LINE_CONTINUATION; }
  yymsp[-2].minor.yy0 = yylhsminor.yy0;
        break;
      case 35: /* nested_chunk ::= empty indented_line */
{ yylhsminor.yy0 = yymsp[-1].minor.yy0; sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); yymsp[0].minor.yy0->type = LINE_CONTINUATION; }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 44: /* definition_block ::= para defs */
{ yylhsminor.yy0 = yymsp[-1].minor.yy0; sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); yymsp[-1].minor.yy0->type = BLOCK_TERM; }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 46: /* def ::= LINE_DEFINITION tail */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[-1].minor.yy0, BLOCK_DEFINITION); sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); sp_mmd_recursive_parse_indent(engine, yylhsminor.yy0); }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 47: /* def ::= LINE_DEFINITION */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_DEFINITION);  }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
...
{ yylhsminor.yy0 = yymsp[-1].minor.yy0; sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); yymsp[0].minor.yy0->child->type = CODE_FENCE; }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
...
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[-1].minor.yy0, BLOCK_LIST_ITEM); sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); sp_mmd_recursive_parse_list_item(engine, yylhsminor.yy0); }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 71: /* item_bullet ::= LINE_LIST_BULLETED chunk */
      case 76: /* item_enum ::= LINE_LIST_ENUMERATED chunk */ yytestcase(yyruleno==76);
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[-1].minor.yy0, BLOCK_LIST_ITEM_TIGHT); sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); sp_mmd_recursive_parse_list_item(engine, yylhsminor.yy0); }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 73: /* item_bullet ::= LINE_LIST_BULLETED */
      case 78: /* item_enum ::= LINE_LIST_ENUMERATED */ yytestcase(yyruleno==78);
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_LIST_ITEM_TIGHT); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 85: /* table_header ::= header_rows LINE_TABLE_SEPARATOR */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[-1].minor.yy0, BLOCK_TABLE_HEADER); sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 86: /* table_header ::= LINE_TABLE_SEPARATOR */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_TABLE_HEADER); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 89: /* table_section ::= all_rows LINE_EMPTY */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[-1].minor.yy0, BLOCK_TABLE_SECTION); sp_mmd_token_chain_append(yymsp[-1].minor.yy0, yymsp[0].minor.yy0); }
  yymsp[-1].minor.yy0 = yylhsminor.yy0;
        break;
      case 90: /* table_section ::= all_rows */
{ yylhsminor.yy0 = sp_mmd_token_new_parent(yymsp[0].minor.yy0, BLOCK_TABLE_SECTION); }
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
