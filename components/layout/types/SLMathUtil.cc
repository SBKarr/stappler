...
This file was modified to fit the stappler project
*/

#include "SPLayout.h"
#include "SLMathUtil.h"
...
#include "SLMathUtilNeon.inl.hpp"
#endif

#ifdef INCLUDE_NEON64
#include "SLMathUtilNeon64.inl.hpp"
#endif

#ifdef INCLUDE_SSE
#include "SLMathUtilSSE.inl.hpp"

#if (ANDROID)
#include <android/log.h>

	class AnrdoidSseChecker {
	public:
		AnrdoidSseChecker()
		{
			if (android_getCpuFamily() == ANDROID_CPU_FAMILY_X86 && (android_getCpuFeatures() & ANDROID_CPU_X86_FEATURE_SSSE3) != 0) {
				_isEnabled = true;
			} else {
				_isEnabled = false;
			}

			__android_log_print(ANDROID_LOG_DEBUG, "SSE", "%d", _isEnabled);
		}
		bool isEnabled() const {return _isEnabled;}
	private:
		bool _isEnabled;
	};
	static AnrdoidSseChecker checker;
#endif

#endif

#include "SLMathUtil.inl.hpp"
...
#ifdef USE_NEON32
	return true;
#elif (defined (INCLUDE_NEON32) && (ANDROID) )
