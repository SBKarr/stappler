...
#ifndef LAYOUT_TYPES_SLMATHUTIL_H_
#define LAYOUT_TYPES_SLMATHUTIL_H_

#ifdef __SSE__
#include <xmmintrin.h>
#endif

#include "SLMathBase.h"
...
constexpr uint32_t MATRIX_SIZE = sizeof(float) * 16;
...
#endif // LAYOUT_TYPES_SLMATHUTIL_H_
