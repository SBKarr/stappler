...
namespace style {
	...
	void writeStyle(StringStream &stream, const style::Size &size) {
		switch (size.metric) {
		case style::Size::Metric::Percent:
			stream << size.value * 100 << "%";
			break;
		case style::Size::Metric::Px:
			stream << size.value << "px";
			break;
		case style::Size::Metric::Em:
			stream << size.value << "em";
			break;
		case style::Size::Metric::Auto:
			stream << "auto";
			break;
		case style::Size::Metric::Dpi:
			stream << size.value << "dpi";
			break;
		case style::Size::Metric::Dppx:
			stream << size.value << "dppx";
			break;
		case style::Size::Metric::Contain:
			stream << "contain";
			break;
		case style::Size::Metric::Cover:
			stream << "cover";
			break;
		}
	}
