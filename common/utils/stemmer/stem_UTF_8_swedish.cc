...
static struct SN_env * swedish_UTF_8_create_env(struct SN_env *z);
...
static struct SN_env * swedish_UTF_8_create_env(struct SN_env *z) { return SN_create_env(z, 0, 2, 0); }
