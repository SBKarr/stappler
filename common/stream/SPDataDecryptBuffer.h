/*
 * SPDataDecryptBuffer.h
 *
 *  Created on: 11 янв. 2016 г.
 *      Author: sbkarr
 */

#ifndef COMMON_STREAM_SPDATADECRYPTBUFFER_H_
#define COMMON_STREAM_SPDATADECRYPTBUFFER_H_
...
class DecryptBuffer : public AllocBase {
public:
	DecryptBuffer() { }
...
#endif /* COMMON_STREAM_SPDATADECRYPTBUFFER_H_ */
