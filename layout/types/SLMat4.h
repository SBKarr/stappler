...
public:
    ...
    /**
     * Constructs a matrix initialized to the specified value for 2D-transform.
     */
    Mat4(float a, float b, float c, float d, float e, float f);
    ...
    /**
     * Sets the values for 2D-transform matrix
     */
